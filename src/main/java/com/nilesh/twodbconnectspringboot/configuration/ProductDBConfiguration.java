...
@EnableJpaRepositories(basePackages = {"com.nilesh.twodbconnectspringboot.product.repository"}, entityManagerFactoryRef = "productDSEmFactory", transactionManagerRef = "productDSTransactionManager")
public class ProductDBConfiguration {

    @Bean
    @ConfigurationProperties("spring.product.datasource2")
